                ...
                <form method="POST" action="{{ route('producten.update', $product->id) }}">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 12px;">
                        ...
                        <div>
                            ...
                            <input type="text" value="Geschikt voor verkoop na baardtrimbehandelingen." class="w-full border border-gray-300 rounded px-3 py-1.5 text-sm bg-gray-100" readonly>
                        </div>
                    </div>
